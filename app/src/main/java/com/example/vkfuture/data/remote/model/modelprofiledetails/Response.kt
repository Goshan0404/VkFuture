package com.example.vkfuture.data.remote.model.modelprofiledetails

data class Response(
    val bdate: String,
    val bdate_visibility: Int,
    val city: com.example.vkfuture.data.remote.model.modelprofiledetails.City,
    val country: com.example.vkfuture.data.remote.model.modelprofiledetails.Country,
